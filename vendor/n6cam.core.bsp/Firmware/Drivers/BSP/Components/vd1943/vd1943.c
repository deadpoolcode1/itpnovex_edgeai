...
#define VD1943_REG_MODEL_ID                                   0x0000
  ...
  /* SIANA: Included support for test sample */
  #define VD1943_MODEL_ID_X_X                                 0x53393432
...
static int VD1943_CheckModelId(VD1943_Ctx_t *ctx)
{
  ...
  /* SIANA: Included support for test sample */
  if (
    reg32 != VD1943_MODEL_ID_1_3 &&
    reg32 != VD1943_MODEL_ID_1_4 &&
    reg32 != VD1943_MODEL_ID_X_X
  ) {
