...
/*--->> USER-APP <<-----------------------------------------------------------*/
/* WHD configuration */
#define RX_PACKET_POOL_SIZE                     30
#define TX_PACKET_POOL_SIZE                     30

/* RTP/RSTP configuration */
#define NX_RTSP_SERVER_MAX_CLIENTS              1
#define NX_RTSP_SERVER_ACTIVITY_TIMEOUT         30

/* Telnet configuration */
#define NX_TELNET_MAX_CLIENTS                   1
#define NX_TELNET_TIMEOUT_PERIOD                10
#define NX_TELNET_ACTIVITY_TIMEOUT              30
#define NX_TELNET_SERVER_PRIORITY               3
